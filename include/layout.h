...
const uint16_t layout[3][4][12] = {
    {// Layer 0 - Standard layout
     ...
     {KEY_QUICK_FN | KEY_LS_MACRO, KEY_MOD_LCTRL | KEY_MOD_MACRO,
      KEY_MOD_LALT | KEY_MOD_MACRO, KEY_MOD_LMETA | KEY_MOD_MACRO, 0, KEY_SPACE,
      KEY_SPACE, KEY_LAYER_UP | KEY_LS_MACRO, KEY_LEFT, KEY_UP, KEY_DOWN,
      KEY_RIGHT}},
    {// Layer 1 - Numbers and symbols
     ...
     {KEY_QUICK_FN | KEY_LS_MACRO, KEY_MOD_LCTRL | KEY_MOD_MACRO,
      KEY_MOD_LALT | KEY_MOD_MACRO, KEY_MOD_LMETA | KEY_MOD_MACRO, KEY_SPACE,
      KEY_SPACE, KEY_SPACE, KEY_LAYER_UP | KEY_LS_MACRO, KEY_LEFT, KEY_UP,
      KEY_DOWN, KEY_RIGHT}},
